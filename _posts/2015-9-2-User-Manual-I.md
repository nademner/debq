...
![Panel de control > Autoservicio]({{ site.url }}{{ site.baseurl }}/assets/user_manual_I/pc_terminales.png)
...
![Panel de control > Movimientos]({{ site.url }}{{ site.baseurl }}/assets/user_manual_I/pc_movimientos.png)
